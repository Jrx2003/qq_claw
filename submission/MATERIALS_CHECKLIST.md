...
- [x] 录屏脚本完成：`submission/VIDEO_SCRIPT_OUTLINE.md`
- [x] PDF 说明文档大纲完成：`submission/PDF_OUTLINE.md`
- [x] 截图位点清单完成：`submission/SCREENSHOT_SHOTLIST.md`
- [x] README for Judges 完成
- [x] 关键数据来源整理完毕

## 仓库内检查
- [x] docs/ 文档齐全
- [x] prompts/ 提示词齐全
- [x] schemas/ 结构化 schema 齐全
- [x] fixtures/ 场景、快照、示例齐全
- [x] assets/ 原型图与参考图齐全
- [x] submission/ 目录齐全
